...
public class EmployeeTable {
    ...
    @OneToOne(targetEntity = DocumentaryFlow.class)
    @JoinColumn(name = "flowno",referencedColumnName = "id")
    private DocumentaryFlow DocumentaryFlow;
    

    public DocumentaryFlow getDocumentaryFlow() {
		return DocumentaryFlow;
	}

	public void setDocumentaryFlow(DocumentaryFlow documentaryFlow) {
		DocumentaryFlow = documentaryFlow;
	}
